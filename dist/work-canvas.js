...
var n = {
	...
	return e = lt(e)[0] || te("Invalid scope") || {}, function(t) {
		var n = e.current || e.nativeElement || e;
		return lt(t, n.querySelectorAll ? n : n === e ? te("Invalid scope") || L.createElement("div") : e);
	};
}, dt = function(e) {
	...
	return d = {
		...
		wake: function() {
			B && (!I && x() && (F = I = window, L = F.document || {}, R.gsap = Gn, (F.gsapVersions || (F.gsapVersions = [])).push(Gn.version), V(z || F.GreenSockGlobals || !F.gsap && F || {}), kt.forEach(At)), u = typeof requestAnimationFrame < "u" && requestAnimationFrame, c && d.sleep(), l = u || function(e) {
...
var rn = function(e, t, n, r, i, a, o) {
	...
	if (h(i) && (~i.indexOf("random(") && (i = St(i)), i.charAt(1) === "=" && (m = G(f, i) + (it(f) || 0), (m || m === 0) && (i = m))), !u || f !== i || ln) return !isNaN(f * i) && i !== "" ? (m = new jn(this._pt, e, t, +f || 0, i - (f || 0), typeof d == "boolean" ? wn : Cn, 0, p), l && (m.fp = l), s && m.modifier(s, this, e), this._pt = m) : (!d && !(t in e) && ee(t, i), rn.call(this, e, t, f, i, p, c || n.stringFilter, l));
	...
	if (E && (!_ || !u) && (u = "none"), t._ease = Yt(u, r.ease), t._rEase = D && (Yt(D) || t._ease), t._from = !E && !!l.runBackwards, t._from && (t.ratio = 1), !E || _ && !l.stagger) {
		if (I = S[0] ? ge(S[0]).harness : 0, B = I && l[I.prop], O = Oe(l, se), x && (x._zTime < 0 && x.progress(1), n < 0 && h && f && !v ? x.render(-1, !0) : x.revert(h && y ? ae : ie), x._lazy = 0), d) {
			...
			if (n && (f = !1), A = we({
				...
				stagger: 0,
				parent: C
			}, O), B && (A[I.prop] = B), Ne(t._startAt = _n.set(S, A)), t._startAt._dp = 0, t._startAt._sat = t, n < 0 && (a ? t._startAt.revert(ae) : t._startAt.render(-1, !0)), t._zTime = n, !f) e(t._startAt, c, c);
			else if (!n) return;
		}
		for (t._pt = t._ptCache = 0, p = y && b(p) || p && !y, k = 0; k < S.length; k++) {
			if (M = S[k], F = M._gsap || H(S)[k]._gsap, t._ptLookup[k] = R = {}, le[F.id] && ce.length && ye(), z = w === S ? k : w.indexOf(M), I && (L = new I()).init(M, B || O, t, z, w) !== !1 && (t._pt = j = new jn(t._pt, M, L.name, 0, 1, L.render, L, 0, L.priority), L._props.forEach(function(e) {
				R[e] = j;
			}), L.priority && (N = 1)), !I || B) for (A in O) de[A] && (L = sn(A, O, t, z, M, w)) ? L.priority && (N = 1) : R[A] = j = an.call(t, M, A, "get", O[A], z, w, 0, l.stringFilter);
			t._op && t._op[k] && t.kill(M, t._op[k]), T && t._pt && (cn = t, P.killTweensOf(M, R, t.globalTime(n)), V = !t.parent, cn = 0), t._pt && p && (le[F.id] = 1);
		}
	...
	if (!c) for (c = e._ptCache[t] = [], d = e._ptLookup, f = e._targets.length; f--;) {
		...
		if (!l) return ln = 1, e.vars[t] = "+=0", un(e, o), ln = 0, s ? te(t + " not eligible for reset. Try splitting into individual properties") : 1;
		c.push(l);
	}
...
var _n = /*#__PURE__*/ function(r) {
	...
	function o(t, a, o, s) {
		...
		if (l._targets = E.length ? H(E) : te("GSAP target " + t + " not found. https://gsap.com", !n.nullTargetWarn) || [], l._ptLookup = [], l._overwrite = h, g || m || S(d) || S(f)) {
			a = l.vars;
...
var Mn = [], Nn = {}, Pn = [], Fn = 0, In = 0, Ln = function(e) {
	...
	registerEffect: function(e) {
		...
		(r || "").split(",").forEach(function(e) {
			return e && !de[e] && !R[e] && te(t + " effect requires " + e + " plugin.");
		}), fe[t] = function(e, t, r) {
...
_n.version = nn.version = Gn.version = "3.15.0", B = 1, x() && Ht(), q.Power0, q.Power1, q.Power2, q.Power3, q.Power4, q.Linear, q.Quad, q.Cubic, q.Quart, q.Quint, q.Strong, q.Elastic, q.Back, q.SteppedEase, q.Bounce, q.Sine, q.Expo, q.Circ;
//#endregion
...
var rc = /*@__PURE__*/ new X(), ic = /*@__PURE__*/ new bo(), ac = 0, oc = class extends lo {
	...
	intersectTriangle(e, t, n, r, i) {
		...
		let P = S / w, F = C / w, I = 1 / w, L = T - P * D, R = E - F * D, z = O - P * A, B = k - F * A, V = j - P * N, ee = M - F * N, te = V * B - ee * z, ne = L * ee - R * V, re = z * R - B * L;
		if (r) {
			if (te < 0 || ne < 0 || re < 0) return null;
		} else if ((te < 0 || ne < 0 || re < 0) && (te > 0 || ne > 0 || re > 0)) return null;
		let ie = te + ne + re;
		if (ie === 0) return null;
		let ae = I * (te * D + ne * A + re * N);
...
function Xf(e, t, n, r, i, a) {
	...
	function h(i, o, l, u, h, g) {
		...
		let Te = {
			...
			emissiveMapUv: te && m(i.emissiveMap.channel),
			...
			vertexTangents: !!v.attributes.tangent && (V || ie),
			...
			decodeVideoTextureEmissive: te && i.emissiveMap.isVideoTexture === !0 && Oo.getTransfer(i.emissiveMap.colorSpace) === "srgb",
...
function _p(e, t) {
	...
	let te = {};
	te[e.TEXTURE_2D] = ee(e.TEXTURE_2D, e.TEXTURE_2D, 1), te[e.TEXTURE_CUBE_MAP] = ee(e.TEXTURE_CUBE_MAP, e.TEXTURE_CUBE_MAP_POSITIVE_X, 6), te[e.TEXTURE_2D_ARRAY] = ee(e.TEXTURE_2D_ARRAY, e.TEXTURE_2D_ARRAY, 1, 1), te[e.TEXTURE_3D] = ee(e.TEXTURE_3D, e.TEXTURE_3D, 1, 1), a.setClear(0, 0, 0, 1), o.setClear(1), s.setClear(0), ne(e.DEPTH_TEST), o.setFunc(3), de(!1), fe(1), ne(e.CULL_FACE), le(0);
	function ne(t) {
	...
	function ge(t, n, r) {
		...
		i === void 0 && (i = {
			type: void 0,
			texture: void 0
		}, L[r] = i), (i.type !== t || i.texture !== n) && (I !== r && (e.activeTexture(r), I = r), e.bindTexture(t, n || te[t]), i.type = t, i.texture = n);
	}
	function _e() {
		let t = L[I];
	...
	function ne(t, r, i, a) {
		...
		if (o.length === 0) n.texSubImage2D(e.TEXTURE_2D, 0, 0, 0, r.width, r.height, i, a, r.data);
			...
			for (let e = 1; e < o.length; e++) {
				let t = o[s], n = o[e], i = t.start + t.count, a = te(n.start, r.width, 4), c = te(t.start, r.width, 4);
				n.start <= i + 1 && a === c && te(n.start + n.count - 1, r.width, 4) === a ? t.count = Math.max(t.count, n.start + n.count - t.start) : (++s, o[s] = n);
			}
			o.length = s + 1;
	...
	function ue(t) {
		...
		if (u) {
			...
			for (let i = 0, a = l.length; i < a; i++) {
				...
				(t.isWebGL3DRenderTarget || t.isWebGLArrayRenderTarget) && (c = t.isWebGL3DRenderTarget ? e.TEXTURE_3D : e.TEXTURE_2D_ARRAY), n.bindTexture(c, o.__webglTexture), V(c, a), ae(s.__webglFramebuffer, t, a, e.COLOR_ATTACHMENT0 + i, c, 0), _(a) && v(c);
			}
			n.unbindTexture();
		} else {
			let r = e.TEXTURE_2D;
			if ((t.isWebGL3DRenderTarget || t.isWebGLArrayRenderTarget) && (r = t.isWebGL3DRenderTarget ? e.TEXTURE_3D : e.TEXTURE_2D_ARRAY), n.bindTexture(r, c.__webglTexture), V(r, i), i.mipmaps && i.mipmaps.length > 0) for (let n = 0; n < i.mipmaps.length; n++) ae(s.__webglFramebuffer[n], t, i, e.COLOR_ATTACHMENT0, r, n);
...
var jp = class {
	constructor(e = {}) {
		...
		let j = 0, M = 0, N = null, P = -1, F = null, I = new zo(), L = new zo(), R = null, z = new Ts(0), B = 0, V = t.width, ee = t.height, te = 1, ne = null, re = null, ie = new zo(0, 0, V, ee), ae = new zo(0, 0, V, ee), oe = !1, se = new Qc(), ce = !1, le = !1, ue = new Wo(), de = new X(), fe = new zo(), pe = {
			background: null,
			fog: null,
			environment: null,
		...
		this.xr = Le, this.getContext = function() {
			...
			e !== void 0 && (te = e, this.setSize(V, ee, !1));
			...
			V = e, ee = n, t.width = Math.floor(e * te), t.height = Math.floor(n * te), r === !0 && (t.style.width = e + "px", t.style.height = n + "px"), w !== null && w.setSize(t.width, t.height), this.setViewport(0, 0, e, n);
		}, this.getDrawingBufferSize = function(e) {
			return e.set(V * te, ee * te).floor();
		}, this.setDrawingBufferSize = function(e, n, r) {
			V = e, ee = n, te = r, t.width = Math.floor(e * r), t.height = Math.floor(n * r), this.setViewport(0, 0, e, n);
		}, this.setEffects = function(e) {
			if (m === 1009) {
			...
			e.isVector4 ? ie.set(e.x, e.y, e.z, e.w) : ie.set(e, t, n, r), U.viewport(I.copy(ie).multiplyScalar(te).round());
		}, this.getScissor = function(e) {
			return e.copy(ae);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? ae.set(e.x, e.y, e.z, e.w) : ae.set(e, t, n, r), U.scissor(L.copy(ae).multiplyScalar(te).round());
		...
		function Qe(e, t, n, r) {
			...
			T.setRenderTarget(a), T.getClearColor(z), B = T.getClearAlpha(), B < 1 && T.setClearColor(16777215, .5), T.clear(), me && ke.render(n);
			let u = T.toneMapping;
			T.toneMapping = 0;
			let d = r.viewport;
		...
		function at(e, t, n, r, i) {
			...
			if ((A.position !== void 0 || A.normal !== void 0 || A.color !== void 0) && Ae.update(i, n, S), (w || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, O.setValue(H, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (k.envMapIntensity.value = t.environmentIntensity), k.dfgLUT !== void 0 && (k.dfgLUT.value = Ap()), w) {
				if (O.setValue(H, "toneMappingExposure", T.toneMappingExposure), v.needsLights && ot(k, E), a && r.fog === !0 && we.refreshFogUniforms(k, a), we.refreshMaterialUniforms(k, r, te, ee, x.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
		...
		this.getActiveCubeFace = function() {
			...
			} else I.copy(ie).multiplyScalar(te).floor(), L.copy(ae).multiplyScalar(te).floor(), R = oe;
...
function Kp(e, t, n, r, i, a, o, s, c) {
	if (e !== s || t !== c) {
		...
		for (var R = Math.ceil(zp(L) / (p / 4)), z = [], B = L / R, V = 4 / 3 * Lp(B / 2) / (1 + Rp(B / 2)), ee = u * n, te = d * n, ne = d * -r, re = u * r, ie = 0; ie < R; ie++) i = I + ie * B, g = Rp(i), _ = Lp(i), j = Rp(i += B), M = Lp(i), z.push(g - V * _, _ + V * g, j + V * M, M - V * j, j, M);
		for (ie = 0; ie < z.length; ie += 2) g = z[ie], _ = z[ie + 1], z[ie] = g * ee + _ * ne + k, z[ie + 1] = g * te + _ * re + A;
		return z[ie - 2] = s, z[ie - 1] = c, z;
	}
}
function qp(e) {
...
function lm(e) {
	...
	if (n === "vimeo.com" || n === "player.vimeo.com") {
		...
		if (n >= 0) {
			let i = e[n], a = t.searchParams.get("h") || (e[n + 1] && /^[\da-f]+$/i.test(e[n + 1]) ? e[n + 1] : ""), o = new URLSearchParams({
				...a ? { h: a } : {},
				title: "0",
				byline: "0",
				portrait: "0",
...
function dm(e, t) {
	...
	n && (e.dataset.provider === "youtube" ? n.postMessage(JSON.stringify({
		event: "command",
		func: t ? "playVideo" : "pauseVideo",
		args: []
	}), "*") : n.postMessage(JSON.stringify({ method: t ? "play" : "pause" }), "*"));
}
function fm(e) {
	let t = e.contentWindow;
	t && (e.dataset.provider === "youtube" ? t.postMessage(JSON.stringify({
		event: "listening",
		id: 1,
		channel: "widget"
...
function pm(e) {
	let t = "";
	try {
		t = new URL(e.origin).hostname;
	} catch {
		return !1;
	}
	if (!/(^|\.)(youtube-nocookie|youtube|vimeo)\.com$/.test(t)) return !1;
	let n = e.data;
	...
	return n?.event === "onStateChange" && n.info === 1 || n?.event === "infoDelivery" && n.info?.playerState === 1 || n?.event === "play";
}
//#endregion
//#region src/core/data.js
var mm = /\.(mp4|webm|mov|m4v)(\?|#|$)/i;
function hm(e, t) {
...
var _m = (e) => [{
	...
	src: e,
	maxEdge: 0
}], vm = (e) => /^(true|1|yes|on)$/i.test(String(e ?? "").trim()), ym = (e) => [...new Set(String(e ?? "").match(/\d+/g)?.map(Number) ?? [])].filter((e) => e >= 1 && e <= 20), bm = 20;
function xm(e) {
	...
	document.querySelectorAll(t).forEach((e, t) => {
		let n = e.dataset, o = (t) => {
			...
			caseStudy: e.querySelector(".work-case-study") ? !!o("work-case-study") : vm(n.caseStudy),
		...
		if (l("image-1") || l("video-1") || e.querySelector("[class*=\"work-image-\"], [class*=\"work-video-\"]")) {
			...
			let e = c, t = ym(l("tiles") || s("work-tiles")), n = t.length ? t : Array.from({ length: r }, (e, t) => t + 1), o = 0;
			for (let t of n) {
				var d;
				let n = u(t), r = i(l(`image-${t}`) || n?.getAttribute("src")), f = i(l(`video-${t}`) || s(`work-video-${t}`)), p = lm(f), m = p ? "" : f;
				if (!r && !m) continue;
				let h = n ? gm(hm(n.getAttribute("srcset"), i)) : [], g = m ? {
					type: "video",
					poster: h[0]?.src || r,
					images: [],
					sources: Cm(m, i(l(`video-${t}-webm`)))
				} : {
					type: "image",
					poster: h[0]?.src || r,
					images: h.length ? h : _m(r),
					sources: []
				};
				(a[d = o++] || (a[d] = [])).push({
					...c,
		...
		let p = (n.type || "").trim().toLowerCase(), m = p === "video" || p === "image" ? p : mm.test(f) ? "video" : "image", h = hm(n.srcset, i), g = i(n.poster) || h[0]?.src || (m === "image" ? f : "");
		m === "image" && !h.length && f && (h = _m(f));
		...
		(a[0] || (a[0] = [])).push({
			...
			poster: g,
			images: h,
			sources: m === "video" ? Cm(f, i(n.srcWebm)) : [],
			slot: 1,
			aspect: _
		});
	});
	let o = a.flat();
	return (e.dataset.shuffle === "false" ? o : Sm(o)).map((e, t) => ({
		...e,
		index: t,
		id: `item-${t}`
	}));
...
function Sm(e) {
	...
	let n = (e) => e.slug || e.title;
	for (let e = 1; e < t.length; e++) {
		if (n(t[e]) !== n(t[e - 1])) continue;
		let r = t.findIndex((r, i) => i > e && n(r) !== n(t[e - 1]));
		r > 0 && ([t[e], t[r]] = [t[r], t[e]]);
	}
	return t;
}
...
async function wm(e, t = 8e3) {
	let n = e.filter((e) => !e.aspect);
	await Promise.all(n.map((e) => Tm(e, t).then((t) => e.aspect = t || 1.5)));
}
function Tm(e, t) {
...
function Am(e, t) {
	...
	for (; c / 2 > a;) c = Math.round(c / 2), l = Math.round(l / 2), s = jm(s, c, l);
	return jm(s, a, o);
}
function jm(e, t, n) {
...
var Pm = class {
	...
	get maxLevel() {
		return this.type === "video" ? 0 : Math.max(0, Math.min(Em.length, this.images.length) - 1);
	}
	setTexture(e, t, n) {
	...
	constructor(e, { maxVideos: t = 5, videoPolicy: n = "all", downgradeAfter: r = 8, maxTextureEdge: i = 1280 } = {}) {
		this.renderer = e, this.maxTextureEdge = i, this.maxVideos = t, this.videoPolicy = n, this.downgradeAfter = r, this.enabled = !0, this.items = [], this.inFlight = 0, this.queue = [], this.uploads = [], this.av1 = Nm("video/webm; codecs=\"av01.0.05M.08\"");
	}
	add(e) {
		let t = new Pm(e, this);
	...
	endFrame(e) {
		for (let e = 0; e < Om && this.uploads.length; e++) {
			let [e, t, n, r] = this.uploads.shift(), i = Mm(new Ro(Am(t, r)));
...
}, Bm = (e) => String(e).replace(/&/g, "&amp;").replace(/</g, "&lt;"), Vm = (e) => String(e ?? "").replace(/\s+/g, " ").trim();
function Hm() {
	let e = document.querySelector("[data-work-about]");
	if (!e) return zm;
	let t = Vm(e.querySelector("p:not([data-about-copyright])")?.textContent) || zm.statement, n = [...e.querySelectorAll("ul")].filter((e) => !e.closest("nav")).map((e) => [...e.querySelectorAll("li")].map((e) => Vm(e.textContent)).filter(Boolean)).filter((e) => e.length), r = [...e.querySelectorAll("a[href]")].map((e) => ({
		label: Vm(e.textContent),
		href: e.getAttribute("href")
	})), i = Vm(e.querySelector("[data-about-copyright]")?.textContent).replace(/^©\s*/, "") || zm.copyright;
	return e.setAttribute("aria-hidden", "true"), e.inert = !0, {
		statement: t,
		clients: n.length ? n : zm.clients,
		links: r.length ? r : zm.links,
		copyright: i
	};
}
function Um() {
	let e = Hm();
	return `
    <p class="wc-about-statement">${Bm(e.statement)}<img src="${Rm}" alt="" width="36" height="36"></p>
    <div class="wc-about-clients" aria-label="Selected clients">
      ${e.clients.map((e) => `<ul>${e.map((e) => `<li>${Bm(e)}</li>`).join("")}</ul>`).join("")}
    </div>
    <div class="wc-about-footer">
      <nav class="wc-about-links" aria-label="Contact">
		...
		return `<a href="${Bm(e.href)}"${t}>${Bm(e.label)} <span class="wc-link-arrow" aria-hidden="true"><span class="wc-link-track"><span>→</span><span class="is-next">→</span></span></span></a>`;
	}).join("")}
      </nav>
      <p class="wc-about-copy"><span aria-hidden="true">©</span><span class="wc-sr"> ${Bm(e.copyright)}</span></p>
    </div>`;
}
//#endregion
...
}, Zm = (e, t) => e.strong.some((e) => t.strong.includes(e)) || (!e.strong.length || !t.strong.length) && e.weak.some((e) => t.weak.includes(e));
function Qm(e, t) {
...
function $m(e, t) {
	...
	if (e.embed.autoplay) {
		let t = e.src ? `<img src="${Jm(e.src)}"${n && e.srcset ? ` srcset="${Jm(e.srcset)}" sizes="(max-width:700px) 100vw, 70vw"` : ""} alt="" ${e.hero ? "decoding=\"sync\"" : "loading=\"lazy\" decoding=\"async\""}${n ? "" : " data-no-fit"}>` : "", o = `<iframe data-src="${Jm(e.embed.loopSrc)}" data-provider="${e.embed.provider}" title="${Jm(a)}" tabindex="-1" allow="autoplay; encrypted-media; picture-in-picture"></iframe>`;
		return `<li class="wc-project-item is-embed is-loop${e.hero ? " is-hero" : ""}" style="aspect-ratio:${i};--ar:${r.toFixed(4)}">${t}${o}</li>`;
	}
	let o = e.src ? `<button type="button" class="wc-embed" data-src="${Jm(um(e.embed))}" data-title="${Jm(a)}" aria-label="Play video: ${Jm(t)}"><img src="${Jm(e.src)}"${n && e.srcset ? ` srcset="${Jm(e.srcset)}" sizes="(max-width:700px) 100vw, 70vw"` : ""} alt="" ${e.hero ? "decoding=\"sync\"" : "loading=\"lazy\" decoding=\"async\""}${n ? "" : " data-no-fit"}><span class="wc-embed-play" aria-hidden="true"></span></button>` : Qm(e.embed.src, a).outerHTML.replace("<iframe", "<iframe loading=\"lazy\"");
...
var eh = class {
	constructor(e, { onEnd: t } = {}) {
		if (!qm) {
			...
			e.textContent = Gm, document.head.appendChild(e);
		}
		this.el = document.createElement("div"), this.el.className = "wc-project", this.el.dataset.wcNoInput = "", this.el.setAttribute("aria-hidden", "true"), this.el.innerHTML = "<div class=\"wc-project-scroll\" tabindex=\"-1\"></div>", this.scroll = this.el.firstElementChild, e.prepend(this.el), this.onEnd = t, this.resetPull(), this.scroll.addEventListener("wheel", (e) => this.onWheel(e), { passive: !0 }), this.scroll.addEventListener("touchstart", (e) => this.onTouchStart(e), { passive: !0 }), this.scroll.addEventListener("touchmove", (e) => this.onTouchMove(e), { passive: !0 }), this.scroll.addEventListener("click", (e) => {
			...
			root: this.scroll,
			threshold: .25
		}), this.loopIO = new IntersectionObserver((e) => e.forEach(({ target: e, isIntersecting: t }) => {
			t && !e.src ? (e.addEventListener("load", () => {
				fm(e), setTimeout(() => e.classList.add("is-on"), 3e3);
			}, { once: !0 }), e.src = e.dataset.src) : e.src && dm(e, t);
		}), {
			root: this.scroll,
			rootMargin: "200px 0px",
			threshold: 0
		}), this._onMessage = (e) => {
			pm(e) && this.el.querySelectorAll(".is-loop iframe:not(.is-on)").forEach((t) => t.contentWindow === e.source && t.classList.add("is-on"));
	...
	render(e, t) {
		...
		for (let t of e.gallery ?? []) {
			let e = Xm(t);
			i.some((t) => Zm(t, e)) || (i.push(e), r.push(t));
		}
		let a = (e.services || "").split(/\s*(?:,|→|\n)\s*/).map((e) => e.trim()).filter(Boolean);
		this.scroll.innerHTML = `
      <div class="wc-project-info">
        <h2 class="wc-project-title">${Jm(e.title)}</h2>
        ${e.description ? `<p class="wc-project-desc">${Jm(e.description)}</p>` : ""}
        ${a.length ? `<ul class="wc-project-services">${a.map((e) => `<li>${Jm(e)}</li>`).join("")}</ul>` : ""}
      </div>
      <ul class="wc-project-media" aria-label="${Jm(e.title)} images">
        ${r.map((t) => {
			if (t.type === "embed" && t.embed) return $m(t, e.title);
			let n = ` style="aspect-ratio:${t.aspect ? t.aspect.toFixed(4) : "1.5"}"`, r = `<img crossorigin="anonymous" src="${Jm(t.src)}"${t.srcset ? ` srcset="${Jm(t.srcset)}" sizes="(max-width:700px) 100vw, 70vw"` : ""} alt="${Jm(t.alt)}" ${t.hero ? "decoding=\"sync\"" : "loading=\"lazy\" decoding=\"async\""}>`, i = t.type === "video" && t.video ? `<video src="${Jm(t.video)}" crossorigin="anonymous" muted loop playsinline preload="metadata"></video>` : "";
		...
		}), this.el.querySelectorAll(".is-loop iframe").forEach((e) => this.loopIO.observe(e)), this.layoutInfo();
	}
	layoutInfo() {
		let e = this.el.querySelector(".wc-project-info");
		if (!e) return;
		let t = parseFloat(getComputedStyle(this.scroll).paddingTop) || 0, n = this.el.clientHeight - Km - e.offsetHeight - t;
	...
	onWheel(e) {
		...
		t - this.lastInput > Wm.gatePause * 1e3 && (this.gestureAtEnd = r), this.endSince = r ? this.endSince || t : 0, this.lastInput = t;
		let i = t - this.endSince >= Wm.holdAtEnd * 1e3;
	...
	addPull(e) {
		this.pull = Math.min(1, this.pull + e / (Wm.pullDistance * this.scroll.clientHeight)), this.pull >= 1 && !this.ended && (this.ended = !0, this.onEnd?.());
	}
	kick() {
	...
	frame(e) {
		this.raf = 0;
		let t = Wm, n = this.lastFrame ? Math.min(.05, (e - this.lastFrame) / 1e3) : 1 / 60;
	...
	drawPull() {
		let e = Wm, t = this.shown, n = this.scroll.querySelector(".wc-project-media"), r = this.scroll.querySelector(".wc-project-info"), i = t > 0 ? String(1 - Math.min(1, Math.max(0, (t - e.fadeFrom) / (1 - e.fadeFrom)))) : "";
	...
	hide() {
		this.el.setAttribute("aria-hidden", "true"), this.el.querySelectorAll("video").forEach((e) => e.pause()), this.el.querySelectorAll(".is-loop iframe[src]").forEach((e) => dm(e, !1)), clearTimeout(this.clearTimer), this.clearTimer = setTimeout(() => this.clear(), 500);
	}
	clear() {
		this.resetPull(), this.el.querySelectorAll("video").forEach((e) => {
			this.io.unobserve(e), e.pause(), e.removeAttribute("src"), e.load();
		}), this.el.querySelectorAll(".is-loop iframe").forEach((e) => this.loopIO.unobserve(e)), this.scroll.innerHTML = "";
	}
	destroy() {
...
function rh() {
	...
	nh = !0;
	let e = document.createElement("style");
	e.dataset.workCanvas = "", e.textContent = th, document.head.appendChild(e);
}
var ih = class {
	constructor(e, { layouts: t, current: n, onAbout: r, onHome: i, tagline: a, hint: o, aboutHref: s = "/about" }) {
		rh(), this.mount = e, this.layouts = t;
      ...
      <section class="wc-about" id="${c}" aria-label="About" data-wc-no-input>${Um()}</section>
      ${o ? `<div class="wc-hint" aria-hidden="true">${o}</div>` : ""}
    `, this.caption = this.root.querySelector(".wc-caption"), this.captionInner = this.root.querySelector(".wc-caption-inner"), this.icon = this.root.querySelector(".wc-icon"), this.tagline = this.root.querySelector(".wc-tagline"), this.about = this.root.querySelector(".wc-about"), ah(this.about.querySelector(".wc-about-statement")), this.about.querySelectorAll(".wc-about-links a").forEach((e) => {
		...
		this.icon.addEventListener("pointerenter", l), this.icon.addEventListener("focus", l), this.tagline.addEventListener("pointerenter", () => this.loopArrow()), this.tagline.addEventListener("focus", () => this.loopArrow()), this.setActive(n), e.appendChild(this.root), this.project = new eh(this.root, {}), this.captionState = {
			target: null,
			shown: null
		};
	}
...
function uh(e, t) {
	...
	let r = document.createElement("ul"), i = e.map((e) => {
		let n = document.createElement("li"), i = document.createElement("a");
		return i.href = t(e.slug), i.textContent = e.title, n.appendChild(i), e.description && n.append(` — ${e.description}`), r.appendChild(n), {
			project: e,
			a: i
		};
	});
...
var gh = class {
	constructor(e, t = {}) {
		...
		this.reducedMotion = n.matches, this._onReducedChange = (e) => this.reducedMotion = e.matches, n.addEventListener?.("change", this._onReducedChange), this._reducedQuery = n, this.isMobile = matchMedia("(pointer: coarse)").matches || window.innerWidth < 768, this.touch = !matchMedia("(hover: hover) and (pointer: fine)").matches, this.viewport = {
			width: 1,
			height: 1
	...
	async init() {
		...
		await wm(this.items), oh(this.items), this.projectPage = !!this.pathSlug() && new Set(this.items.map((e) => e.slug)).size === 1, this._homeTitle = this.isHomePath() ? document.title : this.options.homeTitle;
		let t = this.layoutDefs.map((e) => e.key), n = t.includes(this.options.layout) ? this.options.layout : t[0];
		this.options.rotate && (n = bh(t) ?? n), this.ui = new ih(e, {
		...
		if (this.media = new Fm(this.renderer, {
			...
			return t ? (await this.openProject({ item: t }, {
				push: !1,
				morph: !1
			}), this) : (location.replace(this.options.homePath), this);
		}
	...
	pathSlug() {
		let e = this.options.projectBase, t = location.pathname;
		return t.startsWith(e) && decodeURIComponent(t.slice(e.length).replace(/\/$/, "")) || null;
	}
	slugFromLocation() {
	...
	addSeo() {
		...
		if (this.projectPage) {
			let t = e[0];
			t && mh(t.project, location.href, [t.poster, ...(t.project.gallery ?? []).map((e) => e.src)]);
			return;
		}
		if (!e.length) return;
		let { nav: t, links: n } = uh(e.map((e) => e.project), (e) => this.projectUrl(e));
		n.forEach(({ a: t }, n) => {
			let r = e[n];
			t.addEventListener("focus", () => {
				this.focusedItem = r, this.layout?.focusItem?.(r);
			}), t.addEventListener("blur", () => this.focusedItem = null), t.addEventListener("click", (e) => {
				if (e.metaKey || e.ctrlKey || e.shiftKey || e.button === 1) return;
				e.preventDefault();
				let t = this.layout?.tileForItem(r);
				t?.onScreen ? this.openProject(t) : this.openProjectBySlug(r.slug, { push: !0 });
			});
		}), this.mount.appendChild(t), this.seoNav = t, ph(e.map((e) => e.project), (e) => this.projectUrl(e), (t) => e.find((e) => e.project === t)?.poster);
	}
	createRenderer() {
		let e = new jp({
	...
	async setLayout(e, { initial: t = !1, swap: n = !1 } = {}) {
		...
		if (r) {
			if (this.switching = !0, this.ui?.setActive(e), xh(e), this.options.syncUrl) {
	...
	updateHover() {
		...
		else if (e?.inside && !this.input.pressed?.dragging && !this.openTile && !this.switching && !this.touch && !this.aboutOpen && !this.projectOpen) {
	...
	async openProject(e, { push: t = !0, morph: n = !0 } = {}) {
		...
		await hh(o.bestSrc), this.projectOpen = !0, this.hovered = null, this.mount.classList.remove("is-hovering-tile"), a.render(i, o);
		let s = a.heroRect();
	...
	openProjectBySlug(e, t) {
		...
		return n ? (this.openProject({ item: n }, {
			...t,
			morph: !1
		}), !0) : !1;
	}
	...
	pushProjectState(e) {
		if (!e) return;
		let t = new URL(this.projectUrl(e), location.href);
		history.pushState({
			...history.state || {},
			wcProject: e
		}, "", t);
		let n = this.mediaItems.find((t) => t.project?.slug === e)?.project;
		n && (document.title = `${n.title} — ${this.options.siteName}`);
	}
	replaceUrl(e) {
		let t = new URL(e, location.href), n = new URLSearchParams(location.search);
		n.delete("project"), t.search = n.toString(), history.replaceState({
			...history.state || {},
			wcProject: void 0
		}, "", t);
	}
...
}, _h = "work-canvas:last-version", vh = /(?:^|;)wc-last=([^;]*)/;
function yh() {
	try {
		let e = localStorage.getItem(_h);
		if (e) return e;
	} catch {}
	return vh.exec(window.name || "")?.[1] ?? null;
}
function bh(e) {
	let t = e.indexOf(yh());
...
function xh(e) {
	try {
		localStorage.setItem(_h, e);
	} catch {}
	try {
		window.name = `${(window.name || "").replace(new RegExp(vh.source, "g"), "")};wc-last=${e}`;
	} catch {}
}
//#endregion
...
function Ch(e) {
	...
	return Ch = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(e) {
		return typeof e;
	} : function(e) {
...
var Dh = (e) => Math.min(1, Math.max(0, e)), Oh = class {
	constructor(e, t) {
	...
	makeTiles(e) {
		return this.tiles = e.map((e, t) => new Sh(this.engine, e, t)), this.tiles;
	}
	repeatItems(e) {
		let t = [];
	...
	tileProgress(e) {
		...
		return this.introEase(Dh(this.progress * (1 + t) - e * t));
	}
	applyTransition(e, t) {
	...
	centerScore(e) {
		...
		return Dh(1 - Math.hypot(t, n)) * .99 + .01;
	}
	resize() {}
	update() {}
	dispose() {
...
function Ah(e, t, { minW: n, maxW: r, maxH: i }) {
	let a = t, o = a * e;
...
var jh = class {
	...
	constructor(e, t) {
		super(e, t), this.offset = 0, this.target = 0, this.drift = -t.idleSpeed, this.velocity = 0, this.scrolled = new jh(t.scroll.omega);
	}
	resize(e) {
		...
		let c = kh(this.tiles.length, t.heights.length, t.seed), l = 0;
		this.tiles.forEach((e, o) => {
			let { w: s, h: u } = Ah(e.item.aspect, t.heights[c[o]] * n, {
				minW: i,
				maxW: r,
				maxH: a
			});
...
Eh(Nh, "defaults", Mh), Eh(Nh, "label", "Filmstrip");
//#endregion
...
var Ph = {
	...
	resize(e) {
		...
		this.k = r / t.maxWidth;
		let a = Math.max(...t.heights) * this.k, o = kh(this.tiles.length, t.heights.length, t.seed);
		this.tiles.forEach((e, n) => {
			let { w: s, h: c } = Ah(e.item.aspect, t.heights[o[n]] * this.k, {
				minW: i,
				maxW: r,
				maxH: a
			});
...
Eh(Fh, "defaults", Ph), Eh(Fh, "label", "Deck");
//#endregion
...
var Rh = class extends Oh {
	constructor(e, t) {
		super(e, t), this.scroll = 0, this.scrollSprings = t.columnSpeeds.map((e) => new jh(t.scroll.omega * Math.sqrt(e))), this.slow = 1, this.shiftX = 0, this.shiftV = 0, this.columns = [];
	}
	resize(e) {
		...
		})), l = this.items.length, u = new Map(Lh(this.items, 1).map((e, t) => [e, t])), d = new Map(this.items.map((e) => [e, 0])), f = (e, t) => {
...
Eh(Rh, "defaults", Ih), Eh(Rh, "label", "Masonry");
//#endregion
//#region src/main.js
var zh = [
	{
...
async function Bh(e, t = {}) {
	...
	let a = parseInt(t.maxVideos ?? n.maxVideos, 10), o = zh.map((e) => ({
		...e,
		config: {
			...e.config,
			...t.config?.[e.key] ?? {}
...
typeof window < "u" && (window.WorkCanvas = {
	mount: Bh,
	LAYOUTS: zh
}, document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", Vh, { once: !0 }) : Vh());
//#endregion
export { zh as LAYOUTS, gh as WorkCanvas, Bh as mount };
